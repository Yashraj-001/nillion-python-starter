...
async def main():
    ...
    new_secret = nillion.NadaValues(
        {
            "my_int1": nillion.SecretInteger(20),  # Change the value for the multiplication program
        }
    )
    ...
    computation_time_secrets = nillion.NadaValues({"my_int2": nillion.SecretInteger(15)})  # Change the value for the multiplication program
    # Pay for the compute
